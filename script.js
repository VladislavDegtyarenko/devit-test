...
console.log(task1);
// ["vasya@example.com", "dima@example.com", "colya@example.com", "misha@example.com", "ashan@example.com", "rafshan@example.com", "colya@example.com", "ashan@example.com", "colya@example.com", "ashan@example.com", "rafshan@example.com"]

/* 2 (1бал)
Сделать функцию подсчета среднего значения, 
с возможностью исключения не числовых значений */
